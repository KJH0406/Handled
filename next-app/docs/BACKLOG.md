...
| [02](backlog/ISSUE-02-next-image.md) | `next/image`로 이미지 전환 | open | M | — |
| [03](backlog/ISSUE-03-next-font.md) | Pretendard 셀프 호스팅 (`next/font/local`) | open | S | — |
...
| [09](backlog/ISSUE-09-metadata.md) | 화면별 metadata 분리 (SEO/OG) | open | S | 01 |
